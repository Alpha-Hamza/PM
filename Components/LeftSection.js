...
export default function LeftSection() {
    return (
      ...
      <div className="flex mt-[24px] ">
             <img src="./Images/Li4.svg" alt=" " className="ml-5" />
             <h1 className="text-[#FFFFFF] ml-[8px] font-semibold">Portfolio Overview</h1>

             </div>
             <div className="ml-5 mt-[16px]">
             <h1 className="text-[#9CA3AF]  text-[12px]  font-semibold">Value</h1>
             
             <h1 className="text-[#FFFFFF]  font-normal">$175,000</h1>

             </div>
             <div className="ml-5 mr-5 mt-[16px]">
             ...
             <div className="ml-5 mr-5 my-[16px]">
      ...
      <div className="flex-col mt-[28px] ml-5">
      <div className="flex ">
