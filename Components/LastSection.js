            ...
            <tr className="relative hover:bg-[#0EA5E9]  ">
             ...
             <td className="text-[14px] text-[#FFFFFF] pl-[28px]  rounded-l-[12px]  ">
               <div className="flex-col justify-center items-center w-full h-full">
                 ...
                 <h1 className="text-[12px] text-[#9CA3AF] text-center ">You</h1>
                 #554
               </div>
                 </td>
               ...
               <td className="   pl-[30px] ">
                 ...
                 <img src="./Images/Mi13.svg" alt=" " className="" />
                 <h1 className="text-[14px] text-[#FFFFFF]">Dekester_09</h1>
                 </div>
               </td>
             ...
             <td className="text-[14px] text-[#FFFFFF] pl-[70px] ">800</td>
             <td className="text-[14px] text-[#FFFFFF] pl-[70px] ">
             05h 26m
             </td>
             
               <td className="flex justify-center items-center pl-[100px]   ">
